...
// import ListCharacter from '../Admin/ListCharacter/ListCharacter'
...
//     render() {
//         console.log('this.props.itemCharacter',this.props.itemCharacter)
//         // console.log('this.state.value', this.state.value);
//         // console.log('this.state.value: ', this.props.itemCharacter.name);
